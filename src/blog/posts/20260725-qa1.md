...
下段では、各時刻において、各サイト $i$ のスピンの $z$ 方向を測定した際に、$1$ (つまり下向き) が出てくる確率をヒートマップで表しています。青色ほど確率が小さい、つまりサイト $0$ を取りやすく、赤色ほど確率が大きい、つまり $1$ を取りやすいことを示します。白色は確率 $1/2$、つまり $1$ と $0$ の確率が等しいことを示します。初期時刻では、各サイトのスピンは $x$ 方向に揃っており、実際に真っ白になっています。終時刻では、2番目のサイトのスピンが $1$ 方向に揃い (赤色)、他のサイトは $0$ 方向に揃う (青色) ことがわかります。
