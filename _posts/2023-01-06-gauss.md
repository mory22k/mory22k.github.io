...
赤字で示された箇所に同じものが入ると覚えておけばよい．左辺の正規化定数を右辺に弾き飛ばすと，よくある **ガウス積分 (Gaussian integral)** の公式の形となる．とくに2つ目のベクトル $\bm x$ に対して実行されるガウス積分のことを **多次元ガウス積分 (multidimentional Gaussian integral)** ということがある．
