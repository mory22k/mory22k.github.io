...
このような線形回帰モデルは<tex>$y$</tex>が<tex>$\bm x$</tex>の各要素<tex>$x_1, x_2, \dots, x_n$</tex>の線形結合により表されることを仮定している．こう書き記すと<tex>$\bm x$</tex>がそのまま入力データを表しているように考えてしまいがちだが，実はそうとも限らない．たとえば次式で表される2次多項式モデルを考えてみよう．
